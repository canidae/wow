...
BINDING_NAME_GENESIS_SPECIAL_1 = "Special 1";
BINDING_NAME_GENESIS_SPECIAL_2 = "Special 2";

-- title
Genesis_GUI_title = "Genesis 0.11";

-- tab titles
Genesis_GUI_tab_title = {"Classes", "Mouse", "Priorities", "Settings"};
...
Genesis_GUI_autocancel_healing = "Autocancel healing";
Genesis_GUI_show_all = "Show all healing";
Genesis_GUI_show_me = "Show only healing me";
Genesis_GUI_cooperative = "Cooperative healing";
Genesis_GUI_heal_least_life_left = "Heal least life left";
Genesis_GUI_autocancel_time = "Autocancel time";
Genesis_GUI_hot_cancel = "HOT heal threshold";
Genesis_GUI_hot_value = "HOT value";
Genesis_GUI_hot_value_battle = "HOT value battle";
