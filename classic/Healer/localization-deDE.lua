...
-- healing text
HEAL_TEXT_1 = "Heilt ein befreundetes Ziel um (%d+%.?%d*) bis (%d+%.?%d*) und \195\188ber (%d+%.?%d*) Sek. um weitere (%d+%.?%d*).";
HEAL_TEXT_1b = "Heals a friendly target for (%d+%.?%d*) to (%d+%.?%d*) and another (%d+%.?%d*) to (%d+%.?%d*) over (%d+%.?%d*) sec%."; -- needs translation Regrowth higher ranks.
HEAL_TEXT_2 = "Euer Ziel um (%d+%.?%d*) bis (%d+%.?%d*) Punkt.e. heilen.";
HEAL_TEXT_3 = "Heilt das Ziel (%d+%.?%d*) Sek. lang um (%d+%.?%d*) Schadenspunkt.e..";
HEAL_TEXT_3b = "Heals the target for (%d+%.?%d*) to (%d+%.?%d*) over (%d+%.?%d*) sec%."; -- needs translation rejuv higher ranks.
HEAL_TEXT_4 = "Heilt ein befreundetes Ziel um (%d+%.?%d*) bis (%d+%.?%d*) Punkt.e..";
HEAL_TEXT_5 = "Heilt beim Ziel (%d+%.?%d*) Sek. lang (%d+%.?%d*) Punkt.e. Schaden.";
HEAL_TEXT_5b = "Heilt das Ziel (%d+%.?%d*) Sek. lang um (%d+%.?%d*) bis (%d+%.?%d*) Schadenspunkt.e.%.";
HEAL_TEXT_6 = "Ein langsam zu wirkender Zauber. der ein einzelnes Ziel um (%d+%.?%d*) bis (%d+%.?%d*) Punkt.e. heilt.";
-- note!
-- since german clients use ',' instead of '.' we need to replace all ',' with '.' or the spells won't be detected
HEAL_TEXT_7 = "Heilt das befreundete Ziel um (%d+%.?%d*) bis (%d+%.?%d*) und springt dann weiter. um weitere in der N\195\164he befindliche Ziele zu heilen.  Wenn es auf ein Gruppenmitglied gewirkt wird. springt die Heilung nur auf andere Gruppenmitglieder \195\188ber.  Jeder Sprung verringert die Effektivit\195\164t des Heilens um (%d+%.?%d*)%. Heilt (%d+%.?%d*) Ziele insgesamt.";
HEAL_TEXT_8 = "Nutzt die Seelenkraft des Gruppenmitglieds zum Abschirmen und absorbiert dabei (%d+%.?%d*) Punkt.e. Schaden. H\195\164lt (%d+%.?%d*) Sek. lang an. Solange der Schild h\195\164lt. wird das Zauberwirken durch erlittenen Schaden nicht unterbrochen. Nachdem das Ziel einmal abgeschirmt wurde. kann es (%d+%.?%d*) Sek. lang nicht wieder abgeschirmt werden.";
...
HEAL_INSTANT = "Spontanzauber";

-- mount text
MOUNT_TEXT_1 = "Erh\195\182ht Tempo um 60%.";
MOUNT_TEXT_2 = "Erh\195\182ht Tempo um 100%.";

-- text from extra healing from items
ITEM_HEAL_1 = "Erh.ht durch Zauber und Effekte verursachte Heilung um bis zu (%d+%.?%d*)%.";
ITEM_HEAL_2 = "Erh.ht durch magische Zauber und magische Effekte zugef.gten Schaden und Heilung um bis zu (%d+%.?%d*) Punkt%(e%)%.";
...
SPELL_REGROWTH = "Nachwachsen";
SPELL_RENEW = "Erneuerung";
SPELL_REJUVENATION = "Verj\195\188ngung";
SPELL_BOP = "Segen des Schutzes";
SPELL_PWS = "Machtwort: Schild";
SPELL_WEAKENED_SOUL = "Geschw\195\164chte Seele";
SPELL_PHASE_SHIFT = "Phasenverschiebung";
SPELL_FIRST_AID = "Erste Hilfe";
SPELL_RECENTLY_BANDAGED = "K\195\188rzlich bandagiert";
SPELL_MIND_CONTROL = "Gedankenkontrolle";
SPELL_NATURES_GRACE = "Anmut der Natur";
SPELL_NATURES_SWIFTNESS = "Schnelligkeit der Natur";
SPELL_INNER_FOCUS = "Innerer Fokus";
SPELL_CLEARCASTING = "Freizauberzustand";
SPELL_MOONKIN_FORM = "Moonkingestalt";
SPELL_BANISH = "Verbannen";
SPELL_DEEP_SLUMBER = "Deep Slumber";
SPELL_SPIRIT_TAP = "Willensentzug";
...
-- debuffs
SPELL_REMOVECURSE = "Fluch aufheben";
SPELL_CUREPOISON = "Vergiftung aufheben";
SPELL_CLEANSE = "S\195\164ubern";
SPELL_PURIFY = "L\195\164utern";
SPELL_CUREDISEASE = "Krankheit heilen";
SPELL_DISPELMAGIC = "Magiebannung";
SPELL_REMOVELESSERCURSE = "Geringen Fluch aufheben";
SPELL_ABOLISHPOISON = "Vergiftung heilen";
SPELL_ABOLISHDISEASE = "Krankheit aufheben";

-- buffs
-- druid
SPELL_MOTW = "Mal der Wildnis";
SPELL_GOTW = "Gabe der Wildnis";
SPELL_THORNS = "Dornen";
SPELL_OMEN = "Omen der Klarsicht";

-- hunter
SPELL_TRUESHOT_AURA = "Aura des Volltreffers";

-- mage
SPELL_AMPLIFY = "Magie verst\195\164rken";
SPELL_ARCANE_BRILLIANCE = "Arkane Brillanz";
SPELL_ARCANE_INTELLECT = "Arkane Intelligenz";
SPELL_DAMPEN_MAGIC = "Magie d\195\164mpfen";
SPELL_DETECT_MAGIC = "Magie entdecken";
SPELL_MAGE_ARMOR = "Magische R\195\188stung";
SPELL_FIRE_WARD = "Feuer-Zauberschutz";
SPELL_FROST_ARMOR = "Frostr\195\188stung";
SPELL_FROST_WARD = "Frost-Zauberschutz";
SPELL_ICE_ARMOR = "Eisr\195\188stung";
SPELL_MANA_SHIELD = "Manaschild";

-- paladin
SPELL_BOF = "Segen der Freiheit";
SPELL_BOL = "Segen des Lichts";
SPELL_BOW = "Segen der Weisheit";
SPELL_BOSAC = "Segen der Opferung";
SPELL_BOSAL = "Segen der Rettung";
SPELL_BOSAN = "Segen des Refugiums";
SPELL_BOK = "Segen der K\195\182nige";
SPELL_BOM = "Segen der Macht";
SPELL_GBOL = "Gro\195\159er Segen des Lichts";
SPELL_GBOW = "Gro\195\159er Segen der Weisheit";
SPELL_GBOSAL = "Gro\195\159er Segen der Rettung";
SPELL_GBOSAN = "Gro\195\159er Segen des Refugiums";
SPELL_GBOM = "Gro\195\159er Segen der Macht";
SPELL_GBOK = "Gro\195\159er Segen der K\195\182nige";
SPELL_RIGHTEOUS_FURY = "Zorn der Gerechtigkeit";
SPELL_HOLY_SHOCK = "Heiliger Schock";
SPELL_DIVINE_FAVOR = "G\195\182ttliche Gunst";

-- priest
SPELL_DIVINE_SPIRIT = "G\195\182ttlicher Willen";
SPELL_ELUNES_GRACE = "Elunes Anmut";
SPELL_FEEDBACK = "R\195\188ckkopplung";
SPELL_PWF = "Machtwort: Seelenst\195\164rke";
SPELL_POF = "Gebet der Seelenst\195\164rke";
SPELL_SHADOW_PROTECTION = "Schattenschutz";
SPELL_INNER_FIRE = "Inneres Feuer";
SPELL_FEAR_WARD = "Furchtzauberschutz";
SPELL_TOW = "Ber\195\188hrung der Schw\195\164che";
SPELL_SHADOWFORM = "Schattenform";
SPELL_PRAYER_OF_SPIRIT = "Gebet der Willenskraft";
SPELL_PRAYER_OF_SHADOW_PROTECTION = "Gebet des Schattenschutzes";

-- rogue
SPELL_DETECT_TRAPS = "Fallen entdecken";

-- shaman
SPELL_ELEMENTAL_FOCUS = "Elementarfokus";
SPELL_LIGHTNING_SHIELD = "Blitzschlagschild";
SPELL_ROCKBITER_WEAPON = "Felsbei\195\159erwaffe";
SPELL_WINDFURY_WEAPON = "Windfuror-Waffe";
SPELL_FROSTBRAND_WEAPON = "Waffe des Frostbrands";
SPELL_FLAMETONGUE_WEAPON = "Waffe der Flammenzunge";

-- warlock
SPELL_DEMON_ARMOR = "D\195\164monenhaut";
SPELL_DEMON_SKIN = "D\195\164monenr\195\188stung";
SPELL_DETECT_LINV = "Geringe Unsichtbarkeit entdecken";
SPELL_DETECT_INV = "Unsichtbarkeit entdecken";
SPELL_DETECT_GINV = "Gro\195\159e Unsichtbarkeit entdecken";
SPELL_SHADOW_WARD = "Schatten-Zauberschutz";
SPELL_UNENDING_BREATH = "Unendlicher Atem";
SPELL_FIRE_SHIELD = "Feuerschild";
